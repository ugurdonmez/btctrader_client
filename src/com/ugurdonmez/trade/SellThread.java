...
public class SellThread implements Runnable{
    ...
    public SellThread(double lastBidPrice, double amount, double spreadStopLimit) {
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (lastOrder == null) {
                ...
                Optional<OrderResult> orderResult = btcTraderClient.sellBTCTraderOrder(0, bidPrice, this.amount, 0);
